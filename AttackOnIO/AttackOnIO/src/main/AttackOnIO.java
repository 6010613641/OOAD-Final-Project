...
public class AttackOnIO extends StateBasedGame {
	
	public AttackOnIO(String name) {
		super(name);
	}
	...
	public static void main(String[] args) {
		try {
			...
			AppGameContainer game = new AppGameContainer(new AttackOnIO("AttackOnIO"));
	...
	public static void extractResources() {
		try {
			...
			if(!resOnDisk.exists() || !resOnDisk.isDirectory()) {
				...
				ZipFile zipFile = new ZipFile("AttackOnIO.jar");
